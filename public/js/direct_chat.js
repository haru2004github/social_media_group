...
const chatBackground = document.querySelector("#chatBackground")
...
const setBackground= () => {
    ...
    chatBackground.classList.remove(`dark:bg-slate-900]` )
    chatBackground.classList.add(`bg-[url('https://blog.1a23.com/wp-content/uploads/sites/2/2020/02/pattern-33.svg')]` )
}

const removeBackground= () => {
    localStorage.removeItem('data-background')
    createBackBtn.innerHTML = "Create Background"
    chatBackground.classList.remove(`bg-[url('https://blog.1a23.com/wp-content/uploads/sites/2/2020/02/pattern-33.svg')]` )
    chatBackground.classList.add(`dark:bg-slate-900` )
...
$(document).ready(function(){
    ...
    $('.chat-container').animate({ scrollTop: $('.chat-messages').height() }, 'fast');
