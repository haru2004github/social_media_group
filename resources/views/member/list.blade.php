...
<article  class="md:px-5 lg:px-0 w-full md:w-[70%] md:mx-auto mt-10 md:mt-0">
    ...
    <div class="mt-5 2xl:mt-10 max-w-[900px] dark:bg-[#1E1F23] border-2 border-blue-300/20 dark:border-slate-700  mx-auto overflow-hidden  rounded-2xl shadow-md ">
        ...
        <!-- user list row style -->
        <div id="rowDisplay" class="bg-[#f6f8fc] dark:bg-[#1E1F23] h-[650px] md:h-[500px] max-h-[700px] md:max-h-none 2xl:h-[700px] overflow-y-scroll p-3 2xl:p-10 flex flex-col gap-y-3 md:gap-y-5">
            ...
            <div class="shadow-md dark:shadow-slate-900 p-3 border border-blue-300/50 dark:border-slate-700 rounded-xl justify-between flex gap-x-3 items-center">
                ...
                <div class="parentNode flex items-center gap-x-4 md:gap-x-6">
                    ...
                    <div class="flex items-center gap-x-2">
                        ...
                        @else
                            <a  href="{{ route('member#accountProfilePage',$member->id) }}"  class=" text-white bg-blue-400 hover:bg-blue-500 duration-300 lg:mr-3 text-xs md:text-sm px-3 py-2 rounded-lg flex justify-center items-center shadow-md" title="Profile">
                                View Your Profile
                            </a>
                        @endif
        ...
        <!-- user list with grid  -->
        <div id="gridDisplay" class="hidden bg-[#f6f8fc] dark:bg-[#1E1F23] h-[650px] md:h-[500px] max-h-[700px] md:max-h-nonem 2xl:h-[700px] overflow-y-scroll p-3 md:p-5 2xl:p-10">
