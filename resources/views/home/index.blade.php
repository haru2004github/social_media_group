    ...
    <div class="container mt-12 lg:mt-20 max-w-[1200px] mx-auto 2xl:px-40 lg:px-5">
        ...
        <div id="post{{ $post->id }}" class="parentNode p-4 md:p-5 dark:bg-[#1E1F23] dark:border-slate-700 2xl:px-8  shadow-lg rounded-lg md:rounded-2xl mt-10 border border-slate-300">
            ...
            <div class=" flex justify-between items-center">
                ...
                <div class=" flex items-center gap-x-2 relative z-0">
            ...
            <div class="parentForReaction  grid grid-cols-3 items-center mt-2">
                <div class="reactBtn relative h-full w-full">
                    ...
                    <button  class="reacted h-full w-full hover:bg-[#f2f2f2] dark:hover:bg-slate-800  duration-300 flex items-center justify-center gap-x-2 py-1 md:py-3 border-2 border-slate-300 dark:border-slate-700 border-l-0 @if ($post->image !== null)border-t-0 @endif dark:text-slate-300 ">
                    ...
                    @else
                    <button id="like" class="react h-full w-full hover:bg-[#f2f2f2] dark:hover:bg-slate-800  duration-300 flex items-center justify-center gap-x-2 py-1 md:py-3 border-2 border-slate-300 dark:border-slate-700 border-l-0 @if ($post->image !== null)border-t-0 @endif dark:text-slate-300 ">
                ...
                <a href="{{ route('post#detail',$post->id) }}" class="setScrollTo hover:bg-[#f2f2f2] dark:hover:bg-slate-800 duration-300 flex items-center justify-center gap-x-2 py-1 md:py-3 border-2 border-slate-300 dark:border-slate-700 border-l-0  @if ($post->image !== null)border-t-0 @endif dark:text-slate-300">
                ...
                <a href="{{ route('view#listPage',$post->id) }}" class="setScrollTo hover:bg-[#f2f2f2] dark:hover:bg-slate-800  duration-300 flex items-center justify-center gap-x-2 py-1 md:py-3 border-2 border-slate-300 dark:border-slate-700 border-l-0 border-r-0  @if ($post->image !== null)border-t-0 @endif dark:text-slate-300">
