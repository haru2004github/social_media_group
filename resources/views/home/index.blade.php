...
<article class="px-3 xl:px-5 w-full md:w-[65%] lg:w-[70%] mx-auto md:h-[86vh] xl:h-[84vh] md:overflow-y-scroll">
    ...
    <div class="container mt-12 lg:mt-20 max-w-[1200px] mx-auto 2xl:px-40 lg:px-5">
         <!-- create post section  -->
        <div class="shadow-lg rounded-lg md:rounded-2xl p-4 md:p-5 2xl:p-5 2xl:px-10 border border-slate-300 dark:border-slate-700 overflow-hidden bg-[#f6f6f6] dark:bg-[#1E1F23]">
        ...
        <div id="post{{ $post->id }}" class="parentNode p-4 md:p-5 dark:bg-[#1E1F23] dark:border-slate-700 2xl:px-8  shadow-lg rounded-lg md:rounded-2xl mt-10 border border-slate-300">
            ...
            @endif
            <a  href="{{ route('post#detail',$post->id) }}" class="addViewerBtn text-slate-400 text-sm md:text-lg hover:text-blue-500 duration-300 cursor-pointer">
                See more...
            </a>
            @if ($post->image !== null)
            ...
            <div class="parentForReaction  grid grid-cols-3 items-center mt-2">
                <div class="reactBtn relative h-full w-full">
                    ...
                    <button  class="reacted h-full w-full hover:bg-[#f2f2f2] dark:hover:bg-slate-800  duration-300 flex items-center justify-center gap-x-1 md:gap-x-2 py-1 md:py-3 border-2 border-slate-300 dark:border-slate-700 border-l-0 @if ($post->image !== null)border-t-0 @endif dark:text-slate-300 ">
                        ...
                        <div class="md:bg-blue-500 text-white 2xl:px-5 px-2 md:px-3 py-1 text-xs md:text-sm shadow-lg rounded-lg md:rounded-xl">
                              {{ $post->reaction_count }}
                        </div>
                    </button>

                    @else
                    <button id="like" class="react h-full w-full hover:bg-[#f2f2f2] dark:hover:bg-slate-800  duration-300 flex items-center justify-center gap-x-1 md:gap-x-2 py-1 md:py-3 border-2 border-slate-300 dark:border-slate-700 border-l-0 @if ($post->image !== null)border-t-0 @endif dark:text-slate-300 ">
                        ...
                        <div class="md:bg-blue-500 text-white 2xl:px-5 px-3 py-0 text-sm shadow-lg rounded-xl">
                            {{ $post->reaction_count }}
                        </div>
                    </button>
                    @endif
                ...
                <a href="{{ route('post#detail',$post->id) }}" class="setScrollTo hover:bg-[#f2f2f2] dark:hover:bg-slate-800 duration-300 flex items-center justify-center gap-x-1 md:gap-x-2 py-1 md:py-3 border-2 border-slate-300 dark:border-slate-700 border-l-0  @if ($post->image !== null)border-t-0 @endif dark:text-slate-300">
                ...
                <a href="{{ route('view#listPage',$post->id) }}" class="setScrollTo hover:bg-[#f2f2f2] dark:hover:bg-slate-800  duration-300 flex items-center justify-center gap-x-1 md:gap-x-2 py-1 md:py-3 border-2 border-slate-300 dark:border-slate-700 border-l-0 border-r-0  @if ($post->image !== null)border-t-0 @endif dark:text-slate-300">
...
<article id="groupModal" class="w-full fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] md:w-[380px] p-3 md:p-5 lg:p-10  dark:bg-slate-800 bg-slate-50 z-50 rounded-2xl shadow-xl border border-blue-300/50 opacity-0 pointer-events-none duration-500">
        @if (count($group) == 0)
        ...
        <div class="">
            <div class="flex justify-between items-center">
                ...
                <button type="button" title="Close Modal..." onclick="toggleDisplayForEdit()" class="w-7 h-7 md:w-8 md:h-8 bg-red-400 hover:bg-red-500 duration-300  shadow-lg flex justify-center items-center rounded-full text-white">
                    <svg class="w-5 h-5 md:w-6 md:h-6" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M5.72 5.72a.75.75 0 0 1 1.06 0L12 10.94l5.22-5.22a.749.749 0 0 1 1.275.326a.749.749 0 0 1-.215.734L13.06 12l5.22 5.22a.749.749 0 0 1-.326 1.275a.749.749 0 0 1-.734-.215L12 13.06l-5.22 5.22a.751.751 0 0 1-1.042-.018a.751.751 0 0 1-.018-1.042L10.94 12L5.72 6.78a.75.75 0 0 1 0-1.06Z"/></svg>
                </button>
            </div>
            ...
            <div class="flex gap-x-3 items-end ">
                <div class="mt-5 md:mt-8 w-full">
                    <label class="text-slate-600 dark:text-slate-300" for="name">Group Name</label><br>
                    @if (count($group) == 0)
                    <input required name="name" id="name" class="w-full focus:outline-none text-slate-700 rounded-xl border border-slate-300 shadow-lg px-3 py-1 md:py-2 bg-slate-50 text-md dark:bg-slate-800 dark:border-slate-700 dark:text-slate-300" type="text" value="{{ old('name') }}" placeholder="Enter Group Name...">
                    @else
                    <input required name="name" id="name" class="w-full focus:outline-none text-slate-700 rounded-xl border border-slate-300 shadow-lg px-3 py-1 md:py-2 bg-slate-50 text-md dark:bg-slate-800 dark:border-slate-700 dark:text-slate-300" type="text" value="{{ old('name',$group[0]->name) }}" placeholder="Enter Group Name...">
                    @endif
                ...
                <button type="button">
                    <label for="fileForGroup" class="w-8 h-8 md:w-10  md:h-10 cursor-pointer shadow-md rounded-lg hover:bg-blue-500 duration-300 bg-blue-400 text-white flex justify-center items-center">
            ...
            <div class="mt-5 md:mt-8">
                <button type="submit" class="bg-blue-400 hover:bg-blue-500 dark:bg-blue-500 dark:hover:bg-blue-600 duration-300 py-2 w-full flex justify-center text-white rounded-lg shadow-lg gap-x-1 text-md md:text-lg">
                    <svg class="w-4 h-4 md:w-6 md:h-6" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M21 14v5a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5v2H5v14h14v-5h2z"/><path fill="currentColor" d="M21 7h-4V3h-2v4h-4v2h4v4h2V9h4z"/></svg>
                    @if (count($group) == 0)
                    Create
                    @else
                    Update
...
{{-- post modal  --}}
<article id="postModal" class="w-full fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] md:w-[380px] lg:w-[700px] p-3 md:p-10  dark:bg-slate-800 bg-slate-50 z-50 rounded-2xl shadow-xl border border-blue-300/50 opacity-0 pointer-events-none duration-500">
    <form action="{{ route('post#create')}}" method="Post" enctype="multipart/form-data">
        @csrf
        <article class="flex justify-between items-center">
            <h1 class="text-blue-500 text-2xl">Create Post</h1>
            <button type="button" onclick="toggleDisplayForPost()" class="w-7 h-7 md:w-8 md:h-8 bg-red-400 hover:bg-red-500 duration-300  shadow-lg flex justify-center items-center rounded-full text-white">
                <svg class="w-5 h-5 md:w-6 md:h-6" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M5.72 5.72a.75.75 0 0 1 1.06 0L12 10.94l5.22-5.22a.749.749 0 0 1 1.275.326a.749.749 0 0 1-.215.734L13.06 12l5.22 5.22a.749.749 0 0 1-.326 1.275a.749.749 0 0 1-.734-.215L12 13.06l-5.22 5.22a.751.751 0 0 1-1.042-.018a.751.751 0 0 1-.018-1.042L10.94 12L5.72 6.78a.75.75 0 0 1 0-1.06Z"/></svg>
            </button>
        </article>
            ...
            <div class="flex justify-between items-center">
                <div class="flex gap-x-1">
                    <div class="flex items-center gap-x-3 2xl:gap-x-5 mt-3">
                        ...
                        <div class="">
                            <div class="flex items-center gap-x-1">
                                <a href="{{ route('member#accountProfilePage',Auth::user()->id) }}" class="block text-slate-800 font-medium md:font-semibold dark:text-slate-200 2xl:text-lg">
                                    {{ Auth::user()->name }}
                                </a>
                            </div>
        ...
        <article>
            ...
            <div class=" mt-3 md:mt-5 flex justify-between items-center">
                <button type="button">
                    <label for="fileForPost" class="w-8 md:w-12 h-8 md:h-12 cursor-pointer shadow-md rounded-lg hover:bg-violet-600 duration-300 bg-violet-500 text-white flex justify-center items-center">
