        ...
        <div class="bg-[#f6f8fc] dark:bg-slate-900">
            ...
            <div id="chatBackground" class="chat-container p-5 md:px-10 md:py-8 h-[600px] md:h-[500px] 2xl:h-[550px] overflow-y-scroll dark:bg-slate-900">
                ...
                <div class="flex justify-center items-center h-full text-slate-700 dark:text-slate-200 ">
                    <div class="">
                        <div class="flex justify-center">
                            <div class="w-[100px] h-[100px] md:w-[150px] md:h-[150px] 2xl:w-[200px] 2xl:h-[200px] rounded-full shadow-lg overflow-hidden">
                                @if($chatPerson->image !== null)
                                <img class="w-full" id="previewImageForProfile" src="{{ asset('storage/'.$chatPerson->image) }}" alt="">
                                @else
                                     @if($chatPerson->gender == 'male')
                ...
                <div class="chat-messages">
                    ...
                    <div id="" class="parentMessage flex flex-row-reverse mt-4 md:mt-10">
                        <div class="">
                            <div class="flex justify-center">
                        ...
                        <form class="flex items-center flex-row-reverse" action="{{ route('chat#editMyMessage',$chat->id) }}" method="POST">
                            @csrf
                            <div id="" class="messageContent">
                                <p class=" bg-white dark:bg-slate-800 dark:text-slate-300 dark:border-slate-700 p-3 2xl:p-5 py-2 text-slate-700 rounded-3xl rounded-tr-none shadow-md border border-slate-300 mt-10 mr-2 max-w-lg text-sm md:text-md">
                                    ...
                                    <input required name="message" type="text" class="messageEdit w-[100px] hidden  rounded-lg shadow-inner border border-slate-300 dark:border-slate-700 dark:bg-slate-900 px-3 py-1 focus:outline-none text-sm md:text-md" value="{{ $chat->message }}">
                                    <input  name="receiverId" type="hidden" value="{{ $chat->receiver_id }}">

                                </p>
                                <div class="relative w-full">
                                    <span class="absolute top-2 right-5 dark:text-slate-300 text-slate-700 text-xs               md:text-sm">
                            ...
                            <div id="" class="option parentEditBtn opacity-0 pointer-events-none flex items-center gap-x-1 mt-10 mr-2">
                                ...
                                <button type="submit"  class="editBtn scale-90 hidden text-white bg-violet-400 dark:bg-violet-500 dark:hover:bg-violet-600 hover:bg-violet-500 duration-300 rounded-full w-7 h-7 md:w-9 md:h-9  justify-center items-center shadow-md" title="Update">
