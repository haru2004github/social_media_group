...
<body class="bg-[#fafafa] dark:bg-[#17181c] ">
    <section id="home" class="flex max-w-[1920px] mx-auto">
        ...
        <aside id="aside" class="fixed md:absolute z-30 top-0  lg:static duration-500 lg:left-0 -left-full bg-[#f6f8fc] dark:bg-[#1E1F23] w-[55%] md:w-[35%] lg:w-[25%] h-screen overflow-hidden max-w-[300px] shadow-md lg:ml-0">
            <section class="xl:px-8 px-6 relative ">

                <!-- logo  -->
                <article class="text-2xl lg:text-3xl 2xl:text-4xl text-blue-500 font-bold mt-20 md:mt-14 lg:mt-9 text-center">
                ...
                {{-- Nav Link  --}}
                <article class="mt-10 2xl:mt-16 lg:max-h-[540px] lg:overflow-y-scroll 2xl:max-h-auto 2xl:overflow-y-visible px-1 text-md">
                    <!-- Home  -->
                    <a href="{{ route('home') }}" class="unsetScrollTo dark:bg-[#27282f] dark:hover:bg-slate-700 dark:border-slate-700 dark:hover:border-blue-500 dark:text-slate-300 hover:bg-slate-100 hover:text-blue-500 duration-300 w-full mt-5 2xl:mt-8 border border-slate-300 rounded-2xl text-slate-700 shadow-md px-3 py-2 2xl:px-5 2xl:py-3 flex items-center ">
                    ...
                    <a href="{{ route('notification#listPage') }}" class="unsetScrollTo dark:bg-[#27282f] dark:hover:bg-slate-700  dark:border-slate-700 dark:hover:border-blue-500 dark:text-slate-300 hover:bg-slate-100 hover:text-blue-500 duration-300 w-full mt-5 2xl:mt-8 border border-slate-300 rounded-2xl text-slate-700 shadow-md px-3 py-2 2xl:px-5 2xl:py-3 flex items-center relative">
                    ...
                    <!-- Group Chat  -->
                    <a href="{{ route('group_chat#page') }}" class="unsetScrollTo dark:bg-[#27282f] dark:hover:bg-slate-700  dark:border-slate-700 dark:hover:border-blue-500 dark:text-slate-300 hover:bg-slate-100 hover:text-blue-500 duration-300 mt-5 2xl:mt-8 w-full border border-slate-300 rounded-2xl text-slate-700 shadow-md px-3 py-2 2xl:px-5 2xl:py-3 flex items-center  2xl:gap-x-4 gap-x-2 ">
        ...
        <main class="w-full">
            <div class="relative left-0 top-0 w-full">
                <header class=" fixed top-0 left-0 w-full md:static md:border z-30 border-l-slate-200 dark:border-slate-700 md:py-3 2xl:py-5 px-3 pl-0 md:px-5 2xl:px-8 shadow-md bg-[#f6f8fc] dark:bg-[#1E1F23] flex justify-between items-center">
                    ...
                    <!--  -->
                    <!-- right nav  -->
                    <div class="pointerStatus text-slate-700 dark:text-slate-300 flex items-center xl:gap-x-6 gap-x-2">
                        {{-- //search --}}
                       ...
                       <div class="pointerStatus flex items-center gap-x-3">
                        <h1 class="hidden md:block">
                            {{ Auth::user()->name }}
                        </h1>
                        <div onclick="show('accountModal')" class="w-9 lg:w-12 2xl:w-16 cursor-pointer h-9 lg:h-12 2xl:h-16 overflow-hidden rounded-full shadow-md">
                ...
                <div id="accountModal" class="z-[1000] fixed top-16 left-0 md:static md:top-auto md:left-auto w-full opacity-0  pointer-events-none duration-500 dark:brightness-90">
                    ...
                    <div class="absolute right-0 md:right-8 z-50 flex justify-end bg-blue-400 text-white rounded-xl overflow-hidden ">
                        <div class="shadow-md py-3 ">
                            <a href="{{ route('account#profilePage') }}" class="unsetScrollTo flex items-center gap-x-2 xl:text-xl text-md md:text-lg px-3 md:px-6 lg:px-10 py-2 hover:bg-blue-500 duration-300" >
                            ...
                            <a href="{{ route('account#passwordPage') }}" class="unsetScrollTo flex items-center gap-x-2 xl:text-xl text-md md:text-lg px-3 md:px-6 lg:px-10 py-2 hover:bg-blue-500 duration-300" >
                            ...
                            <form action="{{ route('logout') }}" method="POST">
                                @csrf
                                <button type="submit" class="unsetScrollTo flex items-center gap-x-2 xl:text-xl text-md md:text-lg px-3 md:px-6 lg:px-10 py-2 hover:bg-blue-500 duration-300" >
            ...
            <section id="content" class="pointerStatus pointer-events-auto flex justify-between xl:mt-10 2xl:mt-8 mt-12">
                @yield('content')
                <!-- Noti Alert  -->
