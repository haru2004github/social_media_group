...
<div class="flex items-center">
    ...
    <span class="ms-1 md:ms-2 mt-1 text-md md:text-xl">Reactors' <span class="hidden md:inline">Lists</span></span>
</div>
@endsection
                ...
                <div class="shadow-lg dark:shadow-slate-900 p-3 px-5 border border-blue-300/50 dark:border-slate-700 rounded-xl justify-between flex gap-x-3 items-center">
                    ...
                    <div class="flex items-center gap-x-4 lg:gap-x-6">
                        <div class="flex items-center gap-x-2">
                            ...
                            @else
                            <a href="{{ route('member#accountProfilePage',$reactor->user_id) }}"  class="text-white bg-blue-400 hover:bg-blue-500 duration-300 rounded-full w-7 h-7 md:w-9 md:h-9 flex justify-center items-center shadow-md" title="Profile">
                            ...
                            @if (Auth::user()->id != $reactor->user_id)
                            <a href="{{ route('chat#messagePage',$reactor->user_id) }}"  class="text-white bg-violet-400 hover:bg-violet-500 duration-300 rounded-full w-7 h-7 md:w-9 md:h-9 flex justify-center items-center shadow-md" title="Message">
